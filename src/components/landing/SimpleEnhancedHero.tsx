...
interface SimpleEnhancedHeroProps {
  onStartSession: () => void;
}

const SimpleEnhancedHero: React.FC<SimpleEnhancedHeroProps> = ({ onStartSession }) => {
          ...
          <div className="mb-10 flex flex-wrap justify-center gap-4 sm:gap-6">
            <div className="flex h-16 min-w-[140px] items-center justify-center rounded-full bg-white px-6 py-3 shadow-lg ring-1 ring-gray-200">
              <div className="text-center">
                <div className="flex items-center justify-center gap-2">
                  ...
                  <span className="text-2xl font-bold text-gray-900">{getTotalExperts()}</span>
                </div>
                <div className="text-xs font-medium text-gray-600">Expert Advisors</div>
              </div>
            </div>
            ...
            <div className="flex h-16 min-w-[140px] items-center justify-center rounded-full bg-white px-6 py-3 shadow-lg ring-1 ring-gray-200">
              <div className="text-center">
                <div className="flex items-center justify-center gap-2">
                  <span className="text-lg">🎯</span>
                  <span className="text-2xl font-bold text-gray-900">{getCombinedExperience()}+</span>
                </div>
...
export default SimpleEnhancedHero;